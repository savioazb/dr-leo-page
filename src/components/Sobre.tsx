      ...
      <article className="max-w-[1360px] m-auto flex flex-col lg:flex-row justify-between items-center py-10 px-4 md:px-20 gap-8">
        ...
        <div className="flex flex-col gap-8">
          <p className="max-w-lg text-lg text-white">
            Sobrinho e filho de médico, o Dr. Leonardo Marcolino Ayres já sabia que desde cedo iria seguir pelo
            mesmo caminho. Entrou para a faculdade Souza Marques aos 18 anos de
            idade, com a certeza de que seguiria pelo caminho da cirurgia,
            quando no final do curso decidiu optar pela ortopedia e
            traumatologia.
          </p>
          <p className="max-w-lg text-lg text-white">
          ...
          <p className="max-w-lg text-lg text-white">
            ...
            realizou o treinamento para tornar-se cirurgião de quadril.
            Concluiu os estudos realizando o exame para ser membro da sociedade
