...
export default function SobreTeste() {
  return (
    <section
      id="sobre"
      className="cursor-pointer mb-20 max-w-[1360px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 px-4 py-8 bg-[url('../../public/heart.svg')] bg-[length:800px] bg-center bg-no-repeat md:px-20 md:py-16"
    >
      <motion.div
        className="group flex items-end justify-between p-12 h-[400px] w-[300px] sm:h-[572px] sm:w-[450px] bg-[url('../../public/portrait.png')] bg-cover rounded-xl bg-center shadow-[inset_0_-19px_26px_29px_rgba(0,0,0,0.1)]"
        ...
        viewport={{ once: true }}
      >
        <p className="text-white text-3xl font-bold transition ease-in-out group-hover:text-blue">
          Dr. Leonardo <br />
          Marcolino
        </p>
        <div className="rounded-full border border-white bg-transparent p-2 text-2xl text-white transition ease-in-out group-hover:bg-white group-hover:text-blue">
          <FaLinkedinIn />
        </div>
      </motion.div>
